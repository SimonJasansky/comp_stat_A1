...
The most important reason for these differences is the relationship of the selected node with the other one in the first method, while the varryance between the two nodes is taken into account (F-test), in the second method, firstly, the variance order of the variables is made and then linear regression analysis is performed with those with a smaller variance (LASSO Regression).
